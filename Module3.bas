...
' ==============================================================================
' RESIZE-FUNKSJONALITET: Drag merged cells med Ctrl+klikk
' ==============================================================================
...
Private Sub ResizeMergedAktivitet(wsP As Worksheet, rad As Long, _
    ...
    Call SlettMergedAktivitet(wsP, rad, gammelStartKol)
    ...
    Call LagMergedAktivitet(wsP, rad, nyStartKol, nySluttKol, farge, tekst)
        ...
        If cel.MergeCells Then
            ...
            If Not behandledeAktiviteter.exists(aktKey) Then
                ...
                If aktStartKol >= nyStartKol And aktSluttKol <= nySluttKol Then
                    ...
                    Call SlettMergedAktivitet(wsP, rad, aktStartKol)
